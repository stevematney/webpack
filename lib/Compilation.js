...
const { compareModulesByIndexOrIdentifier, compareModulesByIdOrIdentifier } = require("./util/comparators");
...
class Compilation {
	...
	sortItemsWithModuleIds() {
		this.modules.sort(compareModulesByIdOrIdentifier(this.chunkGraph));
	}
